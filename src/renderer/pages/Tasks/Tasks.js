    ...
    <div className={classes.container}>
      ...
      <ul className={classes['responsive-table']}>
        <li className={classes['table-header']}>
          ...
          <div className={`${classes.col} ${classes['col-2']}`}>Project</div>
          <div className={`${classes.col} ${classes['col-3']}`}>Tracker</div>
          <div className={`${classes.col} ${classes['col-4']}`}>Subject</div>
